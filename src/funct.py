...
def get_rectangles(image,svc , X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins, scales = [1, 1.5, 2, 2.5, 3], 
...
def visualize_bboxes( image ,svc , X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins, scales = [1, 1.5, 2, 2.5, 3], ystarts = [400, 400, 450, 450, 460], ystops = [528, 550, 620, 650, 700]):
    out_rectangles = []
    for scale, ystart, ystop in zip(scales, ystarts, ystops):
...
def find_vehicles(image,detection_info,svc , X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
    bboxes = get_rectangles(image,svc , X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins) 
